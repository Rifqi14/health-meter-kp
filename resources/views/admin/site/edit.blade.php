            ...
            <form id="form" action="{{route('site.update',['id'=>$site->id])}}"  method="post" autocomplete="off">
               ...
               <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="code" name="code" placeholder="Kode" value="{{$site->code}}" required>
                        <p class="help-block">Ex. upgresik (Only letters lowercase input).</p>
                </div>
                <div class="form-group">
                  <label for="name">Nama <b class="text-danger">*</b></label>
                  <input type="text" class="form-control" id="name" name="name" placeholder="Nama" value="{{$site->name}}" required>
                </div>
                <div class="form-group">
                  <label for="phone">Telepon <b class="text-danger">*</b></label>
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                    <input type="text" class="form-control" id="phone" name="phone" placeholder="Telepon" value="{{$site->phone}}" required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="email" class="form-control" id="email" name="email" placeholder="Email"  value="{{$site->email}}" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="address" name="address" placeholder="Alamat" required>{{$site->address}}</textarea>
                </div>

               <div class="form-group">
                <label for="postal_code">Kode Pos <b class="text-danger">*</b></label>
                  <input type="text" class="form-control" id="postal_code" name="postal_code" placeholder="Kode Pos" value="{{$site->postal_code}}" required>
              </div>
               </div>
               <div class="col-md-6">
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="receipt_header">Catatan Kepala </label>
                    <textarea class="form-control summernote" name="receipt_header" id="receipt_header">{{$site->receipt_header}}</textarea>
                </div>
                <div class="form-group">
                  <label for="receipt_footer">Catatan Kaki </label>
                  <textarea class="form-control summernote" name="receipt_footer" id="receipt_footer">{{$site->receipt_footer}}</textarea>
                </div>
               </div>
              </form>
        </div>
