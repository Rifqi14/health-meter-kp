        ...
        <form id="form" action="{{route('site.store')}}" method="post" autocomplete="off">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="surat_pengantar" class="form-control" id="surat_pengantar" required />
            ...
            <div class="form-group">
              ...
              <input type="text" name="resep_dokter" class="form-control" id="resep_dokter" required />
