        ...
        <div class="box box-primary">
            <div class="box-header">
                ...
                <div class="pull-right box-tools">
                    ...
                    <a href="{{route('site.import')}}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Import">
            ...
            { render: function ( data, type, row ) {
                return `<div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ${row.deleted_at ?
                                `@if(in_array('read',$actionmenu))<li><a class="dropdown-item" href="{{url('admin/site')}}/${row.id}"><i class="glyphicon glyphicon-info-sign"></i> Detail</a></li>@endif
                                ...
                                : 
                                `@if(in_array('update',$actionmenu))<li><a class="dropdown-item" href="{{url('admin/site')}}/${row.id}/edit"><i class="glyphicon glyphicon-edit"></i> Edit</a></li>@endif
                                @if(in_array('read',$actionmenu))<li><a class="dropdown-item" href="{{url('admin/site')}}/${row.id}"><i class="glyphicon glyphicon-info-sign"></i> Detail</a></li>@endif
                                @if(in_array('delete',$actionmenu))
