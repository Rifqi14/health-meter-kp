...
@section('title', 'Tambah Health Meter')
@push('breadcrump')
...
<div class="row">
    ...
    <div class="box box-primary">
        <div class="box-header">
          <h3 class="box-title">Tambah Health Meter</h3>
          <!-- tools box -->
        ...
        <div class="box-body">
            <form id="form" action="{{route('healthmeter.store')}}" class="form-horizontal" method="post" autocomplete="off">
               {{ csrf_field() }}
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <textarea class="form-control summernote" id="recomendation" name="recomendation" placeholder="Rekomendasi" required></textarea>
                    </div>
                  </div>
              </form>
        </div>
