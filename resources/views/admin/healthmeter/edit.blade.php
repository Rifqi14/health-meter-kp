            ...
            <form id="form" action="{{route('healthmeter.update',['id'=>$healthmeter->id])}}" class="form-horizontal" method="post" autocomplete="off">
               ...
               <input type="hidden" name="_method" value="put">
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                    <input type="text" class="form-control" id="name" name="name" placeholder="Nama" value="{{$healthmeter->name}}" required>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <textarea class="form-control summernote" id="recomendation" name="recomendation" placeholder="Rekomendasi" required>{{$healthmeter->recomendation}}</textarea>
                    </div>
                  </div>
              </form>
        </div>
