...
@section('title', 'Ubah Kartu Kontrol')
@push('breadcrump')
  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Ubah Kartu Kontrol</h3>
        <!-- tools box -->
      ...
      <div class="box-body">
        <form id="form" action="{{route('controlcard.update', ['id'=>$controlcard->id])}}" class="form-horizontal" method="post"
          autocomplete="off">
          {{ csrf_field() }}
          @method('PUT')
          <div class="form-group">
            <label for="checkup_result_id" class="col-sm-2 control-label">Hasil Pemeriksaan<b class="text-danger">*</b></label>
              <div class="col-sm-6">
                  ...
                  <input type="hidden" name="nid" id="workforce_id" value="{{$controlcard->nid}}">
                  <input type="hidden" name="checkup_examination_evaluation_id" value="{{$controlcard->checkup_examination_evaluation_id}}" id="checkup_examination_evaluation_id">
                  <input type="hidden" name="checkup_examination_evaluation_level_id" value="{{$controlcard->checkup_examination_evaluation_level_id}}" id="checkup_examination_evaluation_level_id">
              </div>
          </div>
          <div class="form-group">
            <label for="date" class="col-sm-2 control-label">Tanggal<b class="text-danger">*</b></label>
              <div class="col-sm-6">
                <input type="text" class="form-control date" value="{{$controlcard->control_date}}" id="control_date" placeholder="Tanggal"
                  name="control_date">
              </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label for="description" class="col-sm-2 control-label">Keterangan <b class="text-danger">*</b></label>
              <div class="col-sm-6">
                <textarea class="form-control summernote" name="description" id="description" value="{{$controlcard->description}}">{{$controlcard->description}}</textarea>
              </div>
          </div>
          <div class="form-group">
  ...
  $(document).ready(function(){
     $('.select2').select2();
      ...
      $("#checkup_result_id").select2({
        ...
        $("#checkup_result_id").select2('data',{
            id:{{$controlcard->checkup_result_id}},
            text:'{{$controlcard->checkupresult->result}}'
        }).trigger('change');
      ...
      $("#examination_evaluation_id").select2('data',{
            id:{{$controlcard->examination_evaluation_id}},
            text:'{{$controlcard->examinationevaluation->result_categories}}'
        }).trigger('change');
      ...
      $("#examination_evaluation_level_id").select2('data',{
            id:{{$controlcard->examination_evaluation_level_id}},
            text:'{{$controlcard->examinationevaluationlevel->examination_level}}'
        }).trigger('change');
      ...
      $("#authorized_official_id").select2('data',{
            id:{{$controlcard->authorized_official_id}},
            text:'{{$controlcard->authorizedofficial->authority}}'
        }).trigger('change');
      ...
      $("#guarantor_id").select2('data',{
            id:{{$controlcard->guarantor_id}},
            text:'{{$controlcard->guarantor->title->name}}'
        }).trigger('change');
