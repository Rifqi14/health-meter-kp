...
@section('title', 'Pertanyaan Assessment')
@section('stylesheets')
<link href="{{asset('adminlte/component/dataTables/css/datatables.min.css')}}" rel="stylesheet">
@endsection
@push('breadcrump')
<li class="active">Pertanyaan Assessment</li>
@endpush
@section('content')
<div class="row">
  <div class="col-lg-12">
  ...
  $(function(){
          ...
          { render: function ( data, type, row ) {
              return `<div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            : 
                            `<li><a class="dropdown-item" href="{{url('admin/assessmentquestion')}}/${row.id}/edit"><i class="glyphicon glyphicon-edit"></i> Edit</a></li>
                            <li><a class="dropdown-item" href="{{url('admin/assessmentquestion')}}/${row.id}"><i class="glyphicon glyphicon-info-sign"></i> Detail</a></li>
    ...
    $(document).on('click','.archive',function(){
        ...
        bootbox.confirm({
            ...
            title:'Mengarsipkan Pertanyaan Assessment?',
            ...
            callback: function(result) {
                    if(result) {
                        ...
                        $.ajax({
                            url: `{{url('admin/assessmentquestion')}}/${id}`,
                            dataType: 'json', 
                            data:data,
                            type:'DELETE',
                            beforeSend:function(){
    ...
    $(document).on('click','.restore',function(){
        ...
        bootbox.confirm({
            ...
            title:'Mengembalikan Pertanyaan Assessment?',
            ...
            callback: function(result) {
                    if(result) {
                        ...
                        $.ajax({
                            url: `{{url('admin/assessmentquestion/restore')}}`,
                            dataType: 'json', 
                            data:data,
                            type:'POST',
                            beforeSend:function(){
    ...
    $(document).on('click','.delete',function(){
        ...
        bootbox.confirm({
            ...
            title:'Menghapus Pertanyaan Assessment?',
            ...
            callback: function(result) {
                    if(result) {
                        ...
                        $.ajax({
                            url: `{{url('admin/assessmentquestion/delete')}}`,
                            dataType: 'json', 
                            data:data,
                            type:'POST',
                            beforeSend:function(){
