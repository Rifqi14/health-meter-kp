...
<div class="row">
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <form id="form" action="{{route('role.update',['id'=>$role->id])}}" class="form-horizontal" method="post" autocomplete="off">
               {{ csrf_field() }}
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Nama" value="{{$role->name}}" required>
                      <p class="help-block">Ex. administrator (Only letters lowercase input).</p>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="display_name" class="col-sm-2 control-label">Nama Tampilan <b class="text-danger">*</b></label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="display_name" name="display_name"  value="{{$role->display_name}}" placeholder="Nama" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="description" class="col-sm-2 control-label">Keterangan</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="description" name="description" value="{{$role->description}}"  placeholder="Keterangan">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" style="padding-top: 1px" for="data_manager">Akses Distrik</label>
                    <div class="col-sm-4">
                      <label><input class="form-control" type="checkbox" name="data_manager" @if ($role->data_manager)
                        checked
                        @endif> <i></i></label>
                    </div>
                  </div>
