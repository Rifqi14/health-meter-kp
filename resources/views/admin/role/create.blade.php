...
<div class="row">
    ...
    <div class="box box-primary">
        <div class="box-header">
          <h3 class="box-title">Tambah Group Modul</h3>
          <!-- tools box -->
        ...
        <div class="box-body">
            <form id="form" action="{{route('role.store')}}" class="form-horizontal" method="post" autocomplete="off">
               {{ csrf_field() }}
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="display_name" name="display_name" placeholder="Nama Tampilan" required>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <label><input class="form-control" type="checkbox" name="guest"> <i></i></label>
                    </div>
                  </div>
                </div>
              </form>
