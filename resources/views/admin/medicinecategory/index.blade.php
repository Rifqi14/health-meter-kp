    ...
    <div class="box box-primary">
      <div class="box-header">
        ...
        <div class="pull-right box-tools">
          <a href="{{route('medicinecategory.create')}}" class="btn btn-primary btn-sm" data-toggle="tooltip"
            title="Tambah">
      ...
      <div class="modal-body">
        <form id="form-search" autocomplete="off">
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label for="name" class="control-label">Arsip Kategori</label>
...
<script type="text/javascript">
  ...
  $(function(){
    dataTable = $('.datatable').DataTable( {
      ...
      order: [[ 6, "asc" ]],
      ajax: {
        url: "{{route('medicinecategory.read')}}",
        type: "GET",
        data:function(data){
        ...
        { render: function ( data, type, row ) {
            return `<div class="dropdown">
                      ...
                      <ul class="dropdown-menu dropdown-menu-right">
                          ${row.deleted_at ?
                          `<li><a class="dropdown-item" href="{{url('admin/medicinecategory')}}/${row.id}"><i class="glyphicon glyphicon-info-sign"></i> Detail</a></li>
                          ...
                          : 
                          `<li><a class="dropdown-item" href="{{url('admin/medicinecategory')}}/${row.id}/edit"><i class="glyphicon glyphicon-edit"></i> Edit</a></li>
                          <li><a class="dropdown-item" href="{{url('admin/medicinecategory')}}/${row.id}"><i class="glyphicon glyphicon-info-sign"></i> Detail</a></li>
    ...
    $(document).on('click','.archive',function(){
      ...
      bootbox.confirm({
        ...
        title:'Mengarsipkan kategori obat?',
        ...
        callback: function(result) {
          if(result) {
            ...
            $.ajax({
              url: `{{url('admin/medicinecategory')}}/${id}`,
              dataType: 'json', 
              data:data,
              type:'DELETE',
              beforeSend:function(){
    ...
    $(document).on('click','.restore',function(){
        ...
        bootbox.confirm({
            ...
            title:'Mengembalikan kategori obat?',
            ...
            callback: function(result) {
                    if(result) {
                        ...
                        $.ajax({
                            url: `{{url('admin/medicinecategory/restore')}}`,
                            dataType: 'json', 
                            data:data,
                            type:'POST',
                            beforeSend:function(){
        ...
        bootbox.confirm({
            ...
            callback: function(result) {
                    if(result) {
                        ...
                        $.ajax({
                            url: `{{url('admin/medicinecategory/delete')}}`,
                            dataType: 'json', 
                            data:data,
                            type:'POST',
                            beforeSend:function(){
