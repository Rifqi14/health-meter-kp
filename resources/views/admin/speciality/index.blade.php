  ...
  $(function(){
      ...
      bootbox.confirm({
        ...
        callback: function(result) {
          if(result) {
            ...
            $.ajax({
              url: `{{url('admin/speciality/restore')}}/${id}`,
              dataType: 'json', 
              data:data,
              type:'GET',
              beforeSend:function(){
    ...
    $(document).on('click','.delete-permanent',function(){
      ...
      bootbox.confirm({
        ...
        title:'Menghapus permanen spesialis?',
        ...
        callback: function(result) {
          if(result) {
            ...
            $.ajax({
              url: `{{url('admin/speciality/delete')}}/${id}`,
              dataType: 'json', 
              data:data,
              type:'GET',
              beforeSend:function(){
