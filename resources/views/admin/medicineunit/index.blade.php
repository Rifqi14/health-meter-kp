      ...
      <div class="modal-body">
        <form id="form-search" autocomplete="off">
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label for="name" class="control-label">Arsip Unit</label>
        ...
        { render: function ( data, type, row ) {
          return `<div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ${row.deleted_at ?
                            `<li><a class="dropdown-item" href="{{url('admin/medicineunit')}}/${row.id}"><i class="glyphicon glyphicon-info-sign"></i> Detail</a></li>
      ...
      bootbox.confirm({
        ...
        callback: function(result) {
          if(result) {
            ...
            $.ajax({
              url: `{{url('admin/medicineunit/restore')}}/${id}`,
              dataType: 'json', 
              data:data,
              type:'GET',
              beforeSend:function(){
      ...
      bootbox.confirm({
        ...
        callback: function(result) {
          if(result) {
            ...
            $.ajax({
              url: `{{url('admin/medicineunit/delete')}}/${id}`,
              dataType: 'json', 
              data:data,
              type:'GET',
              beforeSend:function(){
