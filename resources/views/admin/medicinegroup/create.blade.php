...
@section('title', 'Tambah Kelompok Obat')
@push('breadcrump')
  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Tambah Kelompok Obat</h3>
        <!-- tools box -->
      ...
      <div class="box-body">
        <form id="form" action="{{route('medicinegroup.store')}}" class="form-horizontal" method="post"
          autocomplete="off">
          {{ csrf_field() }}
          <div class="box-body">
