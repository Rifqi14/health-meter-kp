    ...
    <div class="col-md-12">
        <div class="nav-tabs-custom tab-primary">
            <ul class="nav nav-tabs">
              <li  @if(!$employees || Auth::guard('admin')->user()->roles()->first()->name == 'medical') class="active" @endif><a href="#all" data-toggle="tab">Semua</a></li>
            ...
            <div class="tab-content">
                <div class="tab-pane @if(!$employees  || Auth::guard('admin')->user()->roles()->first()->name == 'medical') active @endif" id="all">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if(!$unwell->medical_record_id)
                                                <td class="text-center"><a href="{{url('admin/medicalrecord/create?report_id='.$unwell->id)}}"><span class="label label-danger">Laporan Medis</span></a></td>
                                            @else
                                                <td class="text-center"><a href="{{url('admin/dashboard/medicalrecord/'.$unwell->medical_record_id)}}">Lihat Laporan</a></td>
                                            @endif
                                            @else
                                            @if(!$unwell->medical_record_id)
                                            ...
                                            <tr>
                                                ...
                                                @foreach($formulaall as $formula)
                                                    @foreach($reportall as $report)
                                                        ...
                                                        <td class="text-center"><a href="{{url('admin/dashboard/healthmeter/'.$department->id)}}"><span class="label" style="background-color:{{healthMeter($report->value)}}">{{round($report->value,2)}} %</span></a></td>
                                                        @endif
