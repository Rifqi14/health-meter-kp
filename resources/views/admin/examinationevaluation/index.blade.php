...
@section('title', 'Evaluasi Pemeriksaan')
@section('stylesheets')
<link href="{{asset('adminlte/component/dataTables/css/datatables.min.css')}}" rel="stylesheet">
@endsection
@push('breadcrump')
<li class="active">Evaluasi Pemeriksaan</li>
@endpush
@section('content')
<div class="row">
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Data Evaluasi Pemeriksaan</h3>
        <!-- tools box -->
        <div class="pull-right box-tools">
          <a href="{{route('examinationevaluation.create')}}" class="btn btn-primary btn-sm" data-toggle="tooltip"
            title="Tambah">
        ...
        <table class="table table-striped table-bordered datatable" style="width:100%">
          <thead>
            <tr>
              ...
              <th width="100">Kategori Hasil</th>
...
<script type="text/javascript">
  ...
  $(function(){
    dataTable = $('.datatable').DataTable( {
      ...
      order: [[ 6, "asc" ]],
      ajax: {
        url: "{{route('examinationevaluation.read')}}",
        type: "GET",
        data:function(data){
    ...
    $(document).on('click','.delete',function(){
      ...
      bootbox.confirm({
        ...
        title:'Mengarsipkan evaluasi pemeriksaan?',
        ...
        callback: function(result) {
          if(result) {
            ...
            $.ajax({
              url: `{{url('admin/examinationevaluation')}}/${id}`,
              dataType: 'json', 
              data:data,
              type:'DELETE',
              beforeSend:function(){
    ...
    $(document).on('click','.restore',function(){
      ...
      bootbox.confirm({
        ...
        title:'Mengembalikan evaluasi pemeriksaan?',
        ...
        callback: function(result) {
          if(result) {
            ...
            $.ajax({
              url: `{{url('admin/examinationevaluation/restore')}}/${id}`,
              dataType: 'json', 
              data:data,
              type:'GET',
              beforeSend:function(){
    ...
    $(document).on('click','.delete-permanent',function(){
      ...
      bootbox.confirm({
        ...
        title:'Menghapus permanen evaluasi pemeriksaan?',
        ...
        callback: function(result) {
          if(result) {
            ...
            $.ajax({
              url: `{{url('admin/examinationevaluation/delete')}}/${id}`,
              dataType: 'json', 
              data:data,
              type:'GET',
              beforeSend:function(){
