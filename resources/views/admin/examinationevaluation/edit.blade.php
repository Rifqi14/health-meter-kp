...
@section('title', 'Ubah Evaluasi Pemeriksaan')
@push('breadcrump')
  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Ubah Evaluasi Pemeriksaan</h3>
        <!-- tools box -->
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control" id="examination_type" name="examination_type"
                  placeholder="Deskripsi" value="{{ $evaluation->examination_type_id }}" required>
              </div>
            </div>
            <div class="form-group">
              <label for="result" class="col-sm-2 control-label">Kategori Hasil <b class="text-danger">*</b></label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="result" name="result" placeholder="Deskripsi"
