        ...
        <form id="form" action="{{route('attendancedescription.update', ['id' => $attendance->id])}}" class="form-horizontal" method="post" autocomplete="off">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control" id="code" name="code" placeholder="Kode" value="{{ $attendance->code }}" required>
              </div>
            </div>
            <div class="form-group">
              <label for="name" class="col-sm-2 control-label">Deskripsi <b class="text-danger">*</b></label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="name" name="name" placeholder="Deskripsi" value="{{ $attendance->description }}" required>
              </div>
            </div>
          </div>
        </form>
