...
@endsection
@push('breadcrump')
<li class="active">Pejabat Berwenang</li>
@endpush
@section('content')
<div class="row">
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Data Pejabat Berwenang</h3>
        <!-- tools box -->
        <div class="pull-right box-tools">
          <a href="{{route('authorizedofficial.create')}}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Tambah">
        ...
        <table class="table table-striped table-bordered datatable" style="width:100%">
          <thead>
            <tr>
              ...
              <th width="100">Jenis Kewenangan</th>
              <th width="100">Kewenangan</th>
...
<script type="text/javascript">
  ...
  $(function(){
    ...
    dataTable = $('.datatable').DataTable( {
        ...
        order: [[ 8, "asc" ]],
        ajax: {
            url: "{{route('authorizedofficial.read')}}",
            type: "GET",
            data:function(data){
        ...
        columnDefs:[
            ...
            { render: function ( data, type, row ) {
              return `<span class="label ${row.authority_type == 1 ? 'bg-green' : 'bg-red'}">${row.authority_type == 1 ? 'Approval Sistem' : 'Tanda Tangan Basah'}</span>`
            },targets: [3]
            },
            { render: function ( data, type, row ) {
            ...
            { render: function ( data, type, row ) {
              return `<div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ${row.deleted_at ?
                            `<li><a class="dropdown-item" href="{{url('admin/authorizedofficial')}}/${row.id}"><i class="glyphicon glyphicon-info-sign"></i> Detail</a></li>
                            ...
                            : 
                            `<li><a class="dropdown-item" href="{{url('admin/authorizedofficial')}}/${row.id}/edit"><i class="glyphicon glyphicon-edit"></i> Edit</a></li>
                            <li><a class="dropdown-item" href="{{url('admin/authorizedofficial')}}/${row.id}"><i class="glyphicon glyphicon-info-sign"></i> Detail</a></li>
    ...
    $(document).on('click','.restore',function(){
        ...
        bootbox.confirm({
          ...
          title:'Mengembalikan Pejabat Berwenang?',
          ...
          callback: function(result) {
            if(result) {
              ...
              $.ajax({
                url: `{{url('admin/authorizedofficial/restore')}}/${id}`,
                dataType: 'json', 
                data:data,
                type:'GET',
                beforeSend:function(){
    ...
    $(document).on('click','.delete',function(){
        ...
        bootbox.confirm({
          ...
          title:'Menghapus Pejabat Berwenang?',
          ...
          callback: function(result) {
            if(result) {
              ...
              $.ajax({
                url: `{{url('admin/authorizedofficial/delete')}}/${id}`,
                dataType: 'json', 
                data:data,
                type:'GET',
                beforeSend:function(){
