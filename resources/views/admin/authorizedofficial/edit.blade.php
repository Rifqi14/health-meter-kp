...
@section('title', 'Ubah Pejabat Berwenang')
@push('breadcrump')
  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Ubah Pejabat Berwenang</h3>
        <!-- tools box -->
        ...
        <form id="form" action="{{route('authorizedofficial.update', ['id' => $authority->id])}}" class="form-horizontal" method="post" autocomplete="off">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <label><input class="form-control iCheck" type="checkbox" name="authority_type" @if ($authority->authority_type) checked @endif> <i></i></label>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="number" class="form-control" id="level" name="level" placeholder="Level" value="{{ $authority->level }}" required>
              </div>
            </div>
            <div class="form-group">
