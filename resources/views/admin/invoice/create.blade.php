...
@section('title', 'Tambah Laporan Tagihan')
@push('breadcrump')
    <li><a href="{{route('department.index')}}">Laporan Tagihan</a></li>
...
<div class="row">
    ...
    <div class="box box-primary">
        <div class="box-header">
          <h3 class="box-title">Tambah Laporan Tagihan</h3>
          <!-- tools box -->
        ...
        <div class="box-body">
            <form id="form" action="{{route('invoice.store')}}" class="form-horizontal" method="post" autocomplete="off">
               {{ csrf_field() }}
                <div class="box-body">
                  <div class="form-group">
                    <label for="name" class="col-sm-2 control-label">Tanggal Permohonan <b class="text-danger">*</b></label>
                    <div class="col-sm-6">
                    <input type="text" class="form-control" id="invoice_date" name="invoice_date" placeholder="Tanggal Permohonan" required value="{{date('Y-m-d')}}">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="receive_date" name="receive_date" placeholder="Tanggal Penerimaan">
                    </div>
                  </div>
                  <div class="form-group">
                      ...
                      <table class="table table-bordered table-striped" id="table-prescriptions">
                          ...
                          <tbody>
                            ...
                            <td><input type="hidden" name="invoice_document[]" value="{{$document->id}}"/>{{$document->name}}</td>
                              <td class="text-center"><input type="checkbox" name="document_status[{{$document->id}}]"></td>
                              <td><input type="text" name="notes[{{$document->id}}]" class="form-control"/></td>
                            </tr>
                            @endforeach
                          </tbody>
                      </table>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                       <select id="status" name="status" class="form-control select2" placeholder="Pilih Status" required readonly>
                  ...
                  <div class="form-group">
                    <label for="close_date" class="col-sm-2 control-label">Tanggal Penutupan</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="close_date" name="close_date" placeholder="Tanggal Akhir" disabled>
                    </div>
                  </div>
                </div>
              </form>
