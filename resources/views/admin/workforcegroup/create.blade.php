...
@section('title', 'Tambah Kelompok Workforce')
@push('breadcrump')
<li><a href="{{route('workforcegroup.index')}}">Kelompok Workforce</a></li>
  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Tambah Kelompok Workforce</h3>
        <!-- tools box -->
      ...
      <div class="box-body">
        <form id="form" action="{{route('workforcegroup.store')}}" class="form-horizontal" method="post" autocomplete="off">
          {{ csrf_field() }}
          <div class="box-body">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" style="padding-top: 1px" for="data_manager">Pengelola Data</label>
              <div class="col-sm-4">
