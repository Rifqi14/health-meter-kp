...
@section('title', 'Kelompok Workforce')
@section('stylesheets')
<link href="{{asset('adminlte/component/dataTables/css/datatables.min.css')}}" rel="stylesheet">
@endsection
@push('breadcrump')
<li class="active">Kelompok Workforce</li>
@endpush
@section('content')
<div class="row">
  <div class="col-lg-12">
        ...
        <table class="table table-striped table-bordered datatable" style="width:100%">
          <thead>
            <tr>
              ...
              <th width="200">Pengelola Data</th>
  ...
  $(function(){
            ...
            { render: function ( data, type, row ) {
              return `<div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            : 
                            `<li><a class="dropdown-item" href="{{url('admin/workforcegroup')}}/${row.id}/edit"><i class="glyphicon glyphicon-edit"></i> Edit</a></li>
    ...
    $(document).on('click','.restore',function(){
        ...
        bootbox.confirm({
          ...
          title:'Mengembalikan Kelompok Workforce?',
          ...
          callback: function(result) {
            if(result) {
              ...
              $.ajax({
                url: `{{url('admin/workforcegroup/restore')}}/${id}`,
                dataType: 'json', 
                data:data,
                type:'GET',
                beforeSend:function(){
    ...
    $(document).on('click','.delete',function(){
        ...
        bootbox.confirm({
          ...
          title:'Menghapus Kelompok Workforce?',
          ...
          callback: function(result) {
            if(result) {
              ...
              $.ajax({
                url: `{{url('admin/workforcegroup/delete')}}/${id}`,
                dataType: 'json', 
                data:data,
                type:'GET',
                beforeSend:function(){
