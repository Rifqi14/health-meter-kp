...
<div class="row">
  <div class="col-lg-12">
    <div class="box box-primary">
      ...
      <div class="box-body">
        <form id="form" action="{{route('coveringletter.update',['id'=>$coveringletter->id])}}" class="form-horizontal" method="post"
          autocomplete="off">
          {{ csrf_field() }}
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
                <select id="type" name="type" class="form-control select2" data-placeholder="Pilih Jenis Surat" required>
                    <option value="{{$coveringletter->type}}">{{$coveringletter->type}}</option>
          ...
          <div class="form-group">
            <label for="number" class="col-sm-2 control-label">Nomor Surat<b class="text-danger">*</b></label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="number" value="{{$coveringletter->number}}" placeholder="Nomor Surat"
          ...
          <div class="form-group">
            <label for="date" class="col-sm-2 control-label">Tanggal Surat<b class="text-danger">*</b></label>
              <div class="col-sm-6">
                <input type="text" class="form-control date" id="letter_date" value="{{$coveringletter->letter_date}}" placeholder="Tanggal Surat"
                  name="letter_date">
              </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <input type="hidden" class="form-control" value="{{$coveringletter->patient_site_id}}" id="patient_site_id" name="patient_site_id">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <input type="hidden" class="form-control" value="{{$coveringletter->doctor_site_id}}" id="doctor_site_id" name="doctor_site_id">
              <input type="hidden" class="form-control" value="{{$coveringletter->partner_id}}" id="partner_id" name="partner_id">
              <input type="hidden" class="form-control" value="{{$coveringletter->speciality_id}}" id="speciality_id" name="speciality_id">
            </div>
          </div>
          <div class="form-group">
  ...
  $(document).ready(function(){
     $('.select2').select2();
      ...
      $("#workforce_id").select2('data',{
        id:{{$coveringletter->workforce_id}},
        text:'{{$coveringletter->workforce->name}}'
      }).trigger('change');
      ...
      $("#patient_id").select2('data',{
        id:{{$coveringletter->patient_id}},
        text:'{{$coveringletter->patient->name}}'
      }).trigger('change');
      ...
      $("#doctor_id").select2('data',{
        id:{{$coveringletter->doctor_id}},
        text:'{{$coveringletter->doctor->name}}'
      }).trigger('change');
