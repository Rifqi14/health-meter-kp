...
<div class="row">
    ...
    <div class="box box-primary">
        <div class="box-header">
          <h3 class="box-title">Tambah Medis</h3>
          <!-- tools box -->
        ...
        <div class="box-body">
            <form id="form" action="{{route('medical.store')}}" class="form-horizontal" method="post" autocomplete="off">
               {{ csrf_field() }}
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                       <select id="type" name="type" class="form-control select2" placeholder="Pilih Tipe Medis" required>
                          <option value=""></option>
