...
@section('title', 'Kontak Eart')
@section('stylesheets')
<link href="{{asset('adminlte/component/dataTables/css/datatables.min.css')}}" rel="stylesheet">
@endsection
@push('breadcrump')
<li class="active">Kontak Eart</li>
@endpush
@section('content')
<div class="row">
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Data Kontak Eart</h3>
        <!-- tools box -->
            ...
            { render: function ( data, type, row ) {
              return `<div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a class="dropdown-item" href="{{url('admin/closecontact')}}/${row.id}/edit"><i class="glyphicon glyphicon-edit"></i> Edit</a></li>
        ...
        bootbox.confirm({
          ...
          callback: function(result) {
            if(result) {
              ...
              $.ajax({
                url: `{{url('admin/closecontact/delete')}}/${id}`,
                dataType: 'json', 
                data:data,
                type:'GET',
                beforeSend:function(){
