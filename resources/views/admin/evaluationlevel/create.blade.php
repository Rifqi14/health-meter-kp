...
@section('title', 'Tambah Tingkat Evaluasi Pemeriksaan')
@push('breadcrump')
  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Tambah Tingkat Evaluasi Pemeriksaan</h3>
        <!-- tools box -->
      ...
      <div class="box-body">
        <form id="form" action="{{route('evaluationlevel.store')}}" class="form-horizontal" method="post"
          autocomplete="off">
          {{ csrf_field() }}
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control" id="evaluation" name="evaluation"
                  placeholder="Evaluasi Pemeriksaan" required>
              </div>
            </div>
            <div class="form-group">
              <label for="level" class="col-sm-2 control-label">Tingkat Evaluasi<b class="text-danger">*</b></label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="level" name="level" placeholder="Tingkat Evaluasi" required>
              </div>
            </div>
            <div class="form-group">
