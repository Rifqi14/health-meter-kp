...
@section('title', 'Tingkat Evaluasi Pemeriksaan')
@section('stylesheets')
<link href="{{asset('adminlte/component/dataTables/css/datatables.min.css')}}" rel="stylesheet">
@endsection
@push('breadcrump')
<li class="active">Tingkat Evaluasi Pemeriksaan</li>
@endpush
@section('content')
<div class="row">
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Data Tingkat Evaluasi Pemeriksaan</h3>
        <!-- tools box -->
        <div class="pull-right box-tools">
          <a href="{{route('evaluationlevel.create')}}" class="btn btn-primary btn-sm" data-toggle="tooltip"
            title="Tambah">
      ...
      <div class="box-body">
        <table class="table table-striped table-bordered datatable" style="width:100%">
          <thead>
            <tr>
              <th width="10">#</th>
              <th width="100">Evaluasi Pemeriksaan</th>
              <th width="100">Tingkat Evaluasi</th>
...
<script type="text/javascript">
  ...
  $(function(){
    dataTable = $('.datatable').DataTable( {
      ...
      order: [[ 6, "asc" ]],
      ajax: {
        url: "{{route('evaluationlevel.read')}}",
        type: "GET",
        data:function(data){
        ...
        { render: function ( data, type, row ) {
          html = `<div class="dropdown">
            ...
            if (row.deleted_at) {
              ...
              html += `<li><a class="dropdown-item" href="{{url('admin/evaluationlevel')}}/${row.id}/edit"><i class="glyphicon glyphicon-edit"></i> Edit</a></li>`;
    ...
    $(document).on('click','.delete',function(){
      ...
      bootbox.confirm({
        ...
        title:'Mengarsipkan tingkat evaluasi pemeriksaan?',
        ...
        callback: function(result) {
          if(result) {
            ...
            $.ajax({
              url: `{{url('admin/evaluationlevel')}}/${id}`,
              dataType: 'json', 
              data:data,
              type:'DELETE',
              beforeSend:function(){
    ...
    $(document).on('click','.restore',function(){
      ...
      bootbox.confirm({
        ...
        title:'Mengembalikan tingkat evaluasi pemeriksaan?',
        ...
        callback: function(result) {
          if(result) {
            ...
            $.ajax({
              url: `{{url('admin/evaluationlevel/restore')}}/${id}`,
              dataType: 'json', 
              data:data,
              type:'GET',
              beforeSend:function(){
    ...
    $(document).on('click','.delete-permanent',function(){
      ...
      bootbox.confirm({
        ...
        title:'Menghapus permanen tingkat evaluasi pemeriksaan?',
        ...
        callback: function(result) {
          if(result) {
            ...
            $.ajax({
              url: `{{url('admin/evaluationlevel/delete')}}/${id}`,
              dataType: 'json', 
              data:data,
              type:'GET',
              beforeSend:function(){
