  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Tambah Hasil Pemeriksaan</h3>
        <!-- tools box -->
      ...
      <div class="box-body">
        <form id="form" action="{{route('checkupresult.store')}}" class="form-horizontal" method="post" autocomplete="off">
          {{ csrf_field() }}
          <div class="box-body">
            <div class="well">
            ...
            <div class="well">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="result" name="result" placeholder="Isi Hasil Pemeriksaan" required>
                </div>
              </div>
              <div class="form-group">
                <label for="normal_limit" class="col-sm-2 control-label">Batas Normal <b class="text-danger">*</b></label>
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="normal_limit" name="normal_limit" placeholder="Isi Batas Normal" required>
                </div>
              </div>
              <div class="form-group">
