            ...
            { render: function ( data, type, row ) {
              return `<div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            : 
                            `<li><a class="dropdown-item" href="{{url('admin/agency')}}/${row.id}/edit"><i class="glyphicon glyphicon-edit"></i> Edit</a></li>
                            <li><a class="dropdown-item" href="{{url('admin/agency')}}/${row.id}"><i class="glyphicon glyphicon-info-sign"></i> Detail</a></li>
        ...
        bootbox.confirm({
          ...
          callback: function(result) {
            if(result) {
              ...
              $.ajax({
                url: `{{url('admin/agency/restore')}}/${id}`,
                dataType: 'json', 
                data:data,
                type:'GET',
                beforeSend:function(){
