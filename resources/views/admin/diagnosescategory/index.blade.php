...
@section('title', 'Kategori Diagnosa')
@section('stylesheets')
<link href="{{asset('adminlte/component/dataTables/css/datatables.min.css')}}" rel="stylesheet">
@endsection
@push('breadcrump')
<li class="active">Kategori Diagnosa</li>
@endpush
@section('content')
<div class="row">
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Data Kategori Diagnosa</h3>
        <!-- tools box -->
        <div class="pull-right box-tools">
          <a href="{{route('diagnosescategory.create')}}" class="btn btn-primary btn-sm" data-toggle="tooltip"
            title="Tambah">
...
<script type="text/javascript">
  ...
  $(function(){
    ...
    dataTable = $('.datatable').DataTable( {
        ...
        order: [[ 6, "asc" ]],
        ajax: {
            url: "{{route('diagnosescategory.read')}}",
            type: "GET",
            data:function(data){
