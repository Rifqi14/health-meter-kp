...
@section('title', 'Tambah Kategori Diagnosa')
@push('breadcrump')
  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Tambah Kategori Diagnosa</h3>
        <!-- tools box -->
      ...
      <div class="box-body">
        <form id="form" action="{{route('diagnosescategory.store')}}" class="form-horizontal" method="post"
          autocomplete="off">
          {{ csrf_field() }}
          <div class="box-body">
