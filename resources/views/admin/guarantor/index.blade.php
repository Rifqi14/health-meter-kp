...
@endsection
@push('breadcrump')
<li class="active">Penanggung Jawab</li>
@endpush
@section('content')
<div class="row">
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        ...
        <div class="pull-right box-tools">
          ...
          <a href="#" onclick="exportguarantor()" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Syncronize">
  ...
  $(function(){
    ...
    $(document).on('click','.restore',function(){
        ...
        bootbox.confirm({
          ...
          title:'Mengembalikan Penanggung Jawab?',
          ...
          callback: function(result) {
            if(result) {
              ...
              $.ajax({
                url: `{{url('admin/guarantor/restore')}}/${id}`,
                dataType: 'json', 
                data:data,
                type:'GET',
                beforeSend:function(){
    ...
    $(document).on('click','.delete',function(){
        ...
        bootbox.confirm({
          ...
          title:'Menghapus Penanggung Jawab?',
          ...
          callback: function(result) {
            if(result) {
              ...
              $.ajax({
                url: `{{url('admin/guarantor/delete')}}/${id}`,
                dataType: 'json', 
                data:data,
                type:'GET',
                beforeSend:function(){
...
function exportguarantor() {
    var data = {_token: "{{ csrf_token() }}"}
    $.ajax({
        url: "{{ route('guarantor.export') }}",
        type: 'POST',
        dataType: 'JSON',
        data: data,
        beforeSend:function(){
