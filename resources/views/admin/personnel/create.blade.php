...
@section('title', 'Tambah Lapor (Individu)')
@push('breadcrump')
    <li><a href="{{route('personnel.index')}}">Lapor (Individu)</a></li>
...
<div class="row">
    ...
    <div class="box box-primary">
        <div class="box-header">
          <h3 class="box-title">Tambah  Lapor (Individu)</h3>
          <!-- tools box -->
        ...
        <div class="box-body">
            <form id="form" action="{{route('personnel.store')}}" class="form-horizontal" method="post" autocomplete="off">
               {{ csrf_field() }}
               <fieldset class="scheduler-border">
                <legend class="scheduler-border">Status Karyawan</legend>
                ...
                <div class="form-group">
                  <label for="name" class="col-sm-3 control-label">Status <b class="text-danger">*</b></label>
                  <div class="col-sm-6">
                  <select class="select2 form-control" name="status" placeholder="Pilih Status" required>
                    <option value=""></option>
                  ...
                  <fieldset class="scheduler-border">
                    ...
                    <div class="form-group">
                      <label for="name" class="col-sm-3 control-label">{{$subcategory->name}} <b class="text-danger">*</b>  <i class="fa fa-info-circle text-primary" style="cursor: pointer" data-toggle="modal"
