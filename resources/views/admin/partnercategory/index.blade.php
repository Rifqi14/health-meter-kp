...
<script type="text/javascript">
  ...
  $(function(){
    dataTable = $('.datatable').DataTable( {
      ...
      order: [[ 5, "asc" ]],
      ajax: {
        url: "{{route('partnercategory.read')}}",
        type: "GET",
        data:function(data){
    ...
    $(document).on('click','.restore',function(){
      ...
      bootbox.confirm({
        ...
        title:'Mengembalikan kategori partner?',
        ...
        callback: function(result) {
          if(result) {
            ...
            $.ajax({
              url: `{{url('admin/partnercategory/restore')}}/${id}`,
              dataType: 'json', 
              data:data,
              type:'GET',
              beforeSend:function(){
    ...
    $(document).on('click','.delete-permanent',function(){
      ...
      bootbox.confirm({
        ...
        title:'Menghapus permanen kategori partner?',
        ...
        callback: function(result) {
          if(result) {
            ...
            $.ajax({
              url: `{{url('admin/partnercategory/delete')}}/${id}`,
              dataType: 'json', 
              data:data,
              type:'GET',
              beforeSend:function(){
