...
@section('title', 'Tambah Kategori Partner')
@push('breadcrump')
  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Tambah Kategori Partner</h3>
        <!-- tools box -->
      ...
      <div class="box-body">
        <form id="form" action="{{route('partnercategory.store')}}" class="form-horizontal" method="post"
          autocomplete="off">
          {{ csrf_field() }}
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control" id="name" name="name" placeholder="Kategori Partner" required>
              </div>
            </div>
            <div class="form-group">
