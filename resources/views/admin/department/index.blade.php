        ...
        <div class="box box-primary">
            <div class="box-header">
                ...
                <div class="pull-right box-tools">
                    ...
                    <a href="#" onclick="exportdepartment()" class="btn btn-danger btn-sm text-white" data-toggle="tooltip" title="Export"><i class="fa fa-download"></i></a>
                    @endif
