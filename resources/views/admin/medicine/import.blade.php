...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary" id="participant-preview">
            ...
            <div class="box-body">
                <form id="form" action="{{route('medicine.storemass')}}">
                </form>
        ...
        <div class="overlay-wrapper">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button form="form-import" type="submit" class="btn btn-success" title="Import"><i
