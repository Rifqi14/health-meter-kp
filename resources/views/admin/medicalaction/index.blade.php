...
<script type="text/javascript">
            ...
            { render: function ( data, type, row ) {
                return `<div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ${row.deleted_at ?
                            `<li><a class="dropdown-item" href="{{url('admin/medicalaction')}}/${row.id}"><i class="glyphicon glyphicon-info-sign"></i> Detail</a></li>
    ...
    $(document).on('click','.archive',function(){
        ...
        bootbox.confirm({
          ...
          title:'Mengarsipkan Tindakan Medis?',
    ...
    $(document).on('click','.restore',function(){
        ...
        bootbox.confirm({
          ...
          title:'Mengembalikan Tindakan Medis?',
          ...
          callback: function(result) {
            if(result) {
              ...
              $.ajax({
                url: `{{url('admin/medicalaction/restore')}}/${id}`,
                dataType: 'json', 
                data:data,
                type:'GET',
                beforeSend:function(){
    ...
    $(document).on('click','.delete',function(){
        ...
        bootbox.confirm({
          ...
          title:'Menghapus Tindakan Medis?',
          ...
          callback: function(result) {
            if(result) {
              ...
              $.ajax({
                url: `{{url('admin/medicalaction/delete')}}/${id}`,
                dataType: 'json', 
                data:data,
                type:'GET',
                beforeSend:function(){
