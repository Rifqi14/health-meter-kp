    ...
    <div class="box box-primary">
        <div class="box-header">
          ...
          <div class="pull-right box-tools">
            <a href="{{route('diagnosis.create')}}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Tambah">
              <i class="fa fa-plus"></i>
            </a>
            <a href="{{route('diagnosis.import')}}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Import">
