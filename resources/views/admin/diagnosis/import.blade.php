...
<div class="row">
    <div class="col-lg-12">
    <div class="box box-primary" id="participant-preview">
        ...
        <div class="box-body">
            <form id="form" action="{{route('diagnosis.storemass')}}">
            </form>
    ...
    $("#form").validate({
        ...
        submitHandler: function() { 
            ...
            $.ajax({
                ...
                beforeSend:function(){
                    $('#participant-preview .overlay').removeClass('hidden');
                }
            }).done(function(response){
