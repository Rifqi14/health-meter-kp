...
@section('title', 'Ubah Jaminan Kesehatan')
@section('stylesheets')
  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Ubah Jaminan Kesehatan</h3>
        <!-- tools box -->
      ...
      <div class="box-body">
        <form id="form" action="{{route('healthinsurance.update', ['id' => $insurance->id])}}" class="form-horizontal" method="post" autocomplete="off">
          {{ csrf_field() }}
          @method('PUT')
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <select name="cover_letter_type" id="cover_letter_type" class="form-control select2" required>
                  ...
                  <option value="{{ $key }}" @if ($key==$insurance->cover_letter_type) selected @endif>{{ $item }}</option>
                  @endif
                  @endforeach
                </select>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control" id="letter_number" name="letter_number" placeholder="Nomor Surat" value="{{ $insurance->letter_number }}" required>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control" id="reference_id" name="reference_id" data-placeholder="Pilih Rujukan" value="{{ $insurance->reference_id }}">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <textarea class="form-control summernote" name="description" id="description">{{ $insurance->description }}</textarea>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="input-group" style="margin-right: 14px">
                    <input type="text" class="form-control date-picker" name="date_in" placeholder="Tanggal Masuk" required value="{{ $insurance->date_in }}">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="input-group" style="margin-right: 14px">
                    <input type="text" class="form-control date-picker" name="date" placeholder="Tanggal" required value="{{ $insurance->date }}">
                    <span class="input-group-addon">
                      <i class="fa fa-calendar"></i>
                    </span>
                  </div>
...
<script>
  $(document).ready(function(){
      ...
      @if($insurance->workforce_id)
        $("#workforce_id").select2('data', {id: {{ $insurance->workforce->id }}, text: `{{ $insurance->workforce->name }}`}).trigger('change');
      @endif
      @if($insurance->patient_id)
        $("#patient_id").select2('data', {id: {{ $insurance->patient->id }}, text: `{!! $insurance->patient->name !!}`}).trigger('change');
      @endif
      @if($insurance->partner_id)
        $("#partner_id").select2('data', {id: {{ $insurance->partner->id }}, text: `{!! $insurance->partner->name !!}`}).trigger('change');
      @endif
      @if($insurance->doctor_id)
        $("#doctor_id").select2('data', {id: {{ $insurance->doctor->id }}, text: `{!! $insurance->doctor->name !!}`}).trigger('change');
      @endif
      @if($insurance->inpatient_id)
        $("#inpatient_id").select2('data', {id: {{ $insurance->inpatient->id }}, text: `{!! $insurance->inpatient->name !!}`}).trigger('change');
      @endif
  });
</script>
@endpush