        ...
        <div class="box box-primary">
            <div class="box-header">
                ...
                <div class="pull-right box-tools">
                    <a href="{{route('category.create')}}" class="btn btn-primary btn-sm" data-toggle="tooltip"
                        title="Tambah">
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a class="dropdown-item" href="{{url('admin/category')}}/${row.id}/edit"><i class="glyphicon glyphicon-edit"></i> Edit</a></li>
                        <li><a class="dropdown-item" href="{{url('admin/category')}}/${row.id}"><i class="glyphicon glyphicon-info-sign"></i> Detail</a></li>
