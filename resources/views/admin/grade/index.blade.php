...
@section('title', 'Jenjang Jabatan')
@section('stylesheets')
<link href="{{asset('adminlte/component/dataTables/css/datatables.min.css')}}" rel="stylesheet">
@endsection
@push('breadcrump')
<li class="active">Jenjang Jabatan</li>
@endpush
@section('content')
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header">
                ...
                <div class="pull-right box-tools">
                    ...
                    <a href="#" onclick="exportgrade()" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Syncronize">
...
$(function(){
    ...
    $(document).on('click','.archive',function(){
        ...
        bootbox.confirm({
          ...
          title:'Mengarsipkan Jenjang Jabatan?',
    ...
    $(document).on('click','.restore',function(){
        ...
        bootbox.confirm({
          ...
          title:'Mengembalikan Jenjang Jabatan?',
          ...
          callback: function(result) {
            if(result) {
              ...
              $.ajax({
                url: `{{url('admin/grade/restore')}}/${id}`,
                dataType: 'json', 
                data:data,
                type:'GET',
                beforeSend:function(){
    ...
    $(document).on('click','.delete',function(){
        ...
        bootbox.confirm({
          ...
          title:'Menghapus Jenjang Jabatan?',
