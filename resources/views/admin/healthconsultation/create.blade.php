...
@section('title', 'Tambah Konsultasi Kesehatan')
@push('breadcrump')
<li><a href="{{route('doctor.index')}}">Konsultasi Kesehatan</a></li>
  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Tambah Konsultasi Kesehatan</h3>
        <!-- tools box -->
      ...
      <div class="box-body">
        <form id="form" action="{{route('healthconsultation.store')}}" class="form-horizontal" method="post" autocomplete="off">
          {{ csrf_field() }}
          <div class="well well-sm">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <textarea name="complaint" id="complaint" class="form-control" cols="30" rows="3" placeholder="Keluhan" require></textarea>
              </div>
            </div>
            <div class="form-group">
