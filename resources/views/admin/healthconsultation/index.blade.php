...
@section('title', 'Konsultasi Kesehatan')
@section('stylesheets')
<link href="{{asset('adminlte/component/dataTables/css/datatables.min.css')}}" rel="stylesheet">
@endsection
@push('breadcrump')
<li class="active">Konsultasi Kesehatan</li>
@endpush
@section('content')
<div class="row">
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Data Konsultasi Kesehatan</h3>
        <!-- tools box -->
        <div class="pull-right box-tools">
          <a href="{{route('healthconsultation.create')}}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Tambah">
        ...
        <table class="table table-striped table-bordered datatable" style="width:100%">
          <thead>
            <tr>
              ...
              <th width="200">Distrik Pasien</th>
              <th width="150">Dokter</th>
              <th width="200">Distrik Dokter</th>
...
$(function(){
    dataTable = $('.datatable').DataTable( {
        ...
        order: [[ 6, "asc" ]],
        ajax: {
            url: "{{route('healthconsultation.read')}}",
            type: "GET",
            data:function(data){
            }
        },
            ...
            { render: function ( data, type, row ) {
                return `<div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a class="dropdown-item" href="{{url('admin/healthconsultation')}}/${row.id}/edit"><i class="glyphicon glyphicon-edit"></i> Edit</a></li>
    ...
    $(document).on('click','.delete',function(){
        ...
        bootbox.confirm({
			...
			title:'Menghapus Konsultasi Kesehatan?',
			...
			callback: function(result) {
					if(result) {
						...
						$.ajax({
							url: `{{url('admin/healthconsultation')}}/${id}`,
							dataType: 'json',
							data:data,
							type:'DELETE',
                            beforeSend:function(){
