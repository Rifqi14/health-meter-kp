...
@section('title', 'Tambah Penjadwalan Pemeriksaan')
@push('breadcrump')
  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Tambah Penjadwalan Pemeriksaan</h3>
        <!-- tools box -->
      ...
      <div class="box-body">
        <form id="form" action="{{route('checkupschedule.store')}}" class="form-horizontal" method="post"
          autocomplete="off">
          {{ csrf_field() }}
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <input type="hidden" class="form-control" id="schedule_maker_title_id" name="schedule_maker_title_id">
            </div>
          </div>
           <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <input type="hidden" class="form-control" id="first_approval_title_id" name="first_approval_title_id">
            </div>
          </div>
          <div class="form-group">
            <label for="second_approval_id" class="col-sm-2 control-label">NID Approval 2 <b class="text-danger">*</b></label>
            <div class="col-sm-6">
              ...
              <input type="hidden" class="form-control" id="second_approval_title_id" name="second_approval_title_id">
            </div>
          </div>
        </form>
      </div>
