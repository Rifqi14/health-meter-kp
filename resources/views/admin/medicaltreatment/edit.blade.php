...
@section('title', 'Ubah Penanganan Medis')
@push('breadcrump')
  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Ubah Penanganan Medis</h3>
        <!-- tools box -->
      ...
      <div class="box-body">
        <form id="form" action="{{route('medicaltreatment.update',['id'=>$medicaltreatment->id])}}" class="form-horizontal" method="post" autocomplete="off">
          {{ csrf_field() }}
          ...
          <div class="well well-sm">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="date" name="date" id="date" class="form-control" placeholder="Tanggal" required value="{{$medicaltreatment->date}}">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <textarea class="form-control summernote" name="description"
                            id="description">{{$medicaltreatment->description}}</textarea>
                </div>
            </div>
          </div>
        </form>
...
<script>
  $(document).ready(function(){
    $('input[name=status]').iCheck({
      ...
      @if($medicaltreatment->patient)
      $("#patient").select2('data',{id:{{$medicaltreatment->patient->id}},text:'{{$medicaltreatment->patient->name}}'}).trigger('change');
      @endif
      ...
      @if($medicaltreatment->consultation)
      $("#consultation").select2('data',{id:{{$medicaltreatment->consultation->id}},text:'{{$medicaltreatment->consultation->complaint}}'}).trigger('change');
      @endif
      ...
      @if($medicaltreatment->medicalaction)
      $("#medical_treatment").select2('data',{id:{{$medicaltreatment->medicalaction->id}},text:'{{$medicaltreatment->medicalaction->description}}'}).trigger('change');
      @endif
      ...
      @if($medicaltreatment->doctor)
      $("#doctor").select2('data',{id:{{$medicaltreatment->doctor->id}},text:'{{$medicaltreatment->doctor->name}}'}).trigger('change');
      @endif
