    ...
    <div class="box box-primary">
        <div class="box-header">
          ...
          <div class="pull-right box-tools">
            <a href="{{route('user.create')}}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Tambah">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label" for="display_name">Role</label>
                                <input type="text" name="display_name" class="form-control" placeholder="Role">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
    ...
    dataTable = $('.datatable').DataTable( {
        ...
        ajax: {
            ...
            data:function(data){
                ...
                var email = $('#form-search').find('input[name=email]').val();
