    ...
    <div class="box box-primary">
        ...
        <div class="box-body box-profile">
          ...
          <ul class="list-group list-group-unbordered">
            ...
            <li class="list-group-item">
              <b>Status</b> <span class="pull-right"> <label class="label @if($user->status==1) label-success @else label-danger @endif">@if($user->status==1) Aktif @else Tidak Aktif @endif</label></span>
            </li>
            <li class="list-group-item">
          ...
          <a 
                            onclick="event.preventDefault();
                                          document.getElementById('reset-form').submit();" alt="Reset" class="btn btn-primary btn-block"><b>Reset Password</b></a>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group">
                            ...
                            <div class="input-group-btn"><button class="btn btn-primary" type="submit"><i class="fa fa-plus"></i></button></div>
                        </div>
                    </div>
                </div>
            </form>
