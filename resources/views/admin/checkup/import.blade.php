...
@section('title', 'Import Medical Checkup')
@section('stylesheets')
...
<div class="row">
    <div class="col-lg-12">
    <div class="box box-primary" id="checkup-preview">
        ...
        <div class="box-body">
            <form id="form" action="{{route('checkup.storemass')}}">
            </form>
        ...
        <div class="overlay-wrapper">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="#" class="btn btn-primary export-file" title="Example"><i class="fa fa-download"></i></a>
                    <button form="form-import" type="submit" class="btn btn-success" title="Import"><i class="fa fa-upload"></i></button>
                </div>
            </div>
    ...
    $("#form").validate({
        ...
        submitHandler: function() { 
            ...
            $.ajax({
                ...
                data: {
                    _token: "{{ csrf_token() }}",
                    checkups: JSON.stringify(checkups)
                },
                beforeSend:function(){
                    $('#checkup-preview .overlay').removeClass('hidden');
                }
            }).done(function(response){
